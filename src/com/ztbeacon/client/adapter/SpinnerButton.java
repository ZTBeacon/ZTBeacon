...
public class SpinnerButton extends Button {
	...
	private String type;
	private TextView spinner_1,spinner_2;
	...
	public SpinnerButton(Context context, final int resourceId,
			ViewCreatedListener mViewCreatedListener,int screenWidth,String type) {
		super(context);
		setResIdAndViewCreatedListener(resourceId, mViewCreatedListener,0,type);
		initButton(context);
	}
	 ...
	 */
	public void setResIdAndViewCreatedListener(int mResId, ViewCreatedListener mViewCreatedListener,int screenWidth,String type) {
	...
	public class UMSpinnerDropDownItems extends PopupWindow {
		...
		private void loadViews() {
			...
			spinner_1 = (TextView) v.findViewById(R.id.spinner_tv1);
			spinner_2 = (TextView) v.findViewById(R.id.spinner_tv2);
		    
			spinner_1.setWidth(screenWidth/5*4);
			spinner_2.setWidth(screenWidth/5*4);
			}
			// 计算view宽高
			onMeasured(v);
